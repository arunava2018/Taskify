...
export const FEATURES = [
  {
    ...
    description: "Organize your personal tasks with a simple and intuitive to-do list. Create, update, and manage your daily tasks with ease.",
    icon: Lock,
  },
  {
    id: 2,
    title: "Shared Tasks",
    description: "Collaborate with your team by sharing tasks. Everyone stays on the same page and can contribute to progress.",
    icon: Users,
  },
  {
    id: 3,
    title: "One-Click Sharing",
    description: "Enable sharing with a toggle and instantly generate a secure share link with a unique code for controlled access.",
    icon: Share2,
  },
  {
    id: 4,
    title: "Accept or Decline Invites",
    description: "When someone shares a task, you can accept or decline it. Accepted tasks automatically appear in your shared section.",
    icon: Activity,
  },
  {
    id: 5,
    title: "Smart Task Completion",
    description: "Track your progress effortlessly with clean visuals. Mark tasks as done and feel the satisfaction of getting things done.",
    icon: CheckSquare,
  },
]
export const TESTIMONIALS = [
  {
    ...
    company: "TechFlow",
    feedback: "Taskify completely transformed how our remote team collaborates. The seamless sharing feature eliminated our project bottlenecks, and we saw a 40% increase in productivity within the first month. It's intuitive enough that everyone adopted it immediately.",
  ...
  },
  {
    ...
    feedback: "As someone who juggles multiple projects daily, Taskify's toggle between personal and team tasks is a game-changer. No more switching between different tools - everything lives in one clean, fast interface that actually works.",
  ...
  },
  {
    ...
    feedback: "Managing research projects with multiple stakeholders used to be chaotic. Taskify's collaborative features help us track deliverables across teams effortlessly. The clean design means less time learning the tool and more time on actual research.",
  ...
  },
  {
    ...
    feedback: "We tried 7 different task management tools before finding Taskify. Finally, something that doesn't overwhelm with features we don't need. The sharing functionality is so smooth that our entire team was up and running in under 10 minutes.",
  ...
  },
  {
    ...
    feedback: "Our design team needed something visual and collaborative without the complexity. Taskify strikes the perfect balance - powerful enough for our workflow but simple enough that freelancers can jump in immediately. Love the clean interface!",
  ...
  },
  {
    ...
    feedback: "The simplicity is deceptive - behind that clean interface is everything we need for cross-departmental projects. Task sharing feels natural, and the performance is lightning fast even with our 200+ person team using it daily.",
